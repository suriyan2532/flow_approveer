...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    },
    {
      name: t("finance"),
      href: "#",
      icon: DollarSign, // Ensuring DollarSign is used
      children: [
  ...
  return (
    <div className="flex h-screen bg-[#f1f4f6] font-sans text-[#495057]">
      {/* Sidebar - Kero Style: Dark/Blueish background */}
      <aside
        className={`${
      ...
      <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${isSidebarOpen ? "ml-[280px]" : "ml-[80px]"}`}>
        ...
        {/* Header - Kero Style */}
        <header className="h-[60px] bg-white/80 backdrop-blur-md shadow-[0_0.46875rem_2.1875rem_rgba(4,9,20,0.03),0_0.9375rem_1.40625rem_rgba(4,9,20,0.03),0_0.25rem_0.53125rem_rgba(4,9,20,0.05),0_0.125rem_0.1875rem_rgba(4,9,20,0.03)] flex items-center justify-between px-6 sticky top-0 z-20 transition-all duration-300">
          <div className="flex items-center">
            <button
